...
4. By default the page is saved as "Unpublished". To have the page show on your site you will need to click the "Unpublished" icon to set it to "Published". If at any time you would like to Unpublished the page then just click the "Published" icon and it will change to "Unpublished".
